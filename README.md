...
- Create reusable infrastructure using variables.
- Configure different environments using `.tfvars` files.
- Retrieve existing AWS resources using Data Sources.
- Create and manage EC2 instances using Terraform.
- Configure Security Groups.
- Use Terraform state.
- Validate and format Terraform code.
- Plan, apply, and destroy AWS infrastructure.
...
- ✅ 4 AWS Data Sources
- ✅ Environment-specific EC2 infrastructure
- ✅ Automated resource tagging
- ✅ Terraform validation and formatting
- ✅ GitHub version control
- ✅ Infrastructure can be created and destroyed through Terraform